...
const uiSchema = {
  ...
  properties: {
    actionButton: {
      "ui:widget": "button",
      "ui:options": { "value": "Custom button 1", "onClick": () => { window.alert("Custom button pressed"); } },
      "className": "btn btn-success mt-3",
    },
    myButton: {
      "ui:widget": "button",
      "ui:options": { "value": "Custom button 2", "onClick": () => { window.alert("My button pressed"); } },
...
```
Users just need to define input field. Label and errors are displayed by custom rjsf. 
...
| `fieldName`   | The normalized field name used as the key in `formData`.                      |
